 ...
 */
public class BinaryTreeInorderTraversal_Solution_Test {
    @Test
    void case_01_null() {
        TreeNode treeNode = Utils.prepareTree(new Integer[]{null});
        List<Integer> integers = new BinaryTreeInorderTraversal_Solution().inorderTraversal(treeNode);
    ...
    void case_Provided_01() {
        ...
        List<Integer> result = new BinaryTreeInorderTraversal_Solution().inorderTraversal(treeNode);
    ...
    void case_Provided_04() {
        ...
        List<Integer> result = new BinaryTreeInorderTraversal_Solution().inorderTraversal(treeNode);
        List<Integer> expected = Arrays.asList(new Integer[]{4,2,5,1,6,3,7});
        validate(result, expected);
    }
